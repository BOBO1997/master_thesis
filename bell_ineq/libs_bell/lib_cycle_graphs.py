...
def prepare_cycle_graph_qcs(qc,
                           backend,
...
def prepare_cycle_graph_qcs_list(qc_graphs,  # list of qiskit.QuantumCircuit
...
def correlations_of_cycle_graphs(adj_lists, Fs, hist_list, silent = True):
    """
    Input
        adj_lists         : list of adjacency list
